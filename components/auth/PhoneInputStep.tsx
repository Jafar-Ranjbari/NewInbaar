  ...
  return (
    <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2">برای شروع شماره موبایل خود را وارد کنید</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            dir="ltr"
            placeholder="0912..."
            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-left placeholder-right"
            value={mobile}
